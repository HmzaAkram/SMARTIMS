<nav class="bg-gradient-to-r from-indigo-600 to-indigo-800 shadow-lg">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:ml-10 md:flex md:space-x-1">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="<?php echo e(request()->routeIs('admin.dashboard') ? 'bg-indigo-700 text-white' : 'text-indigo-100 hover:bg-indigo-700 hover:text-white'); ?> px-4 py-2 rounded-md text-sm font-medium transition duration-150 ease-in-out">
    ...
    <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 -translate-y-1" class="md:hidden bg-indigo-700" style="display: none;">
        <div class="px-2 pt-2 pb-3 space-y-1">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="<?php echo e(request()->routeIs('admin.dashboard') ? 'bg-indigo-800 text-white' : 'text-indigo-100 hover:bg-indigo-600'); ?> block px-3 py-2 rounded-md text-base font-medium">Dashboard</a>
...
<div x-data="{ mobileMenuOpen: false }"></div><?php /**PATH C:\Users\HP\Documents\GitHub\SMARTIMS\resources\views/layouts/super-admin-navigation.blade.php ENDPATH**/ ?>