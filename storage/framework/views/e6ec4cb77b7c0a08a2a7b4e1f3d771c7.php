...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['href' => route('company.dashboard', ['tenant' => request()->route('tenant')]),'active' => request()->routeIs('company.dashboard')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('company.dashboard', ['tenant' => request()->route('tenant')])),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('company.dashboard'))]); ?>
...
<?php /**PATH C:\Users\HP\Documents\GitHub\SMARTIMS\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>