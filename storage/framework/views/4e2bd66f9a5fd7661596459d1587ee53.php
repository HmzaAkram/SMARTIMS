...
<?php $__env->startSection('title', 'Categories - SmartIMS'); ?>
...
<div class="space-y-6">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Manage your inventory categories</p>
        </div>
        <div class="mt-4 sm:mt-0">
            <a href="<?php echo e(route('company.categories.create', ['tenant' => request()->route('tenant')])); ?>" class="inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500">
    ...
    <div class="rounded-lg bg-white shadow p-4">
        <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
            ...
            <div class="md:col-span-2">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="search" placeholder="Search categories..." class="block w-full rounded-md border-0 py-2 pl-10 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                </div>
            </div>
        </div>
        ...
        <div class="mt-4 flex items-center justify-between">
            ...
            <div class="text-sm text-gray-500">
                Showing <?php echo e($categories->firstItem() ?? 1); ?> to <?php echo e($categories->lastItem() ?? 10); ?> of <?php echo e($categories->total() ?? 0); ?> results
            </div>
        </div>
    </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Items Count</th>
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="whitespace-nowrap px-3 py-4 text-sm font-medium text-gray-900"><?php echo e($category->name); ?></td>
                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?php echo e($category->description ?? 'No description'); ?></td>
                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-900"><?php echo e($category->items_count); ?></td>
                        <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                            <div class="flex justify-end space-x-2" x-data="{ open: false }">
                                <a href="<?php echo e(route('company.categories.edit', [request()->route('tenant'), $category])); ?>" class="text-gray-600 hover:text-gray-900">Edit</a>
                                    ...
                                    <div class="flex min-h-screen items-end justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                                        ...
                                        <div x-show="open" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100 translate-y-0 sm:scale-100" x-transition:leave-end="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" class="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                                            ...
                                            <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                                <form method="POST" action="<?php echo e(route('company.categories.destroy', [request()->route('tenant'), $category])); ?>" class="inline">
                                                    <?php echo csrf_field(); ?>
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-14 text-center">
                            ...
                            <div class="mt-6">
                                <a href="<?php echo e(route('company.categories.create', request()->route('tenant'))); ?>" class="inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500">
                                    <svg class="-ml-0.5 mr-1.5 h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                        <path d="M10.75 4.75a.75.75 0 00-1.5 0v4.5h-4.5a.75.75 0 000 1.5h4.5v4.5a.75.75 0 001.5 0v-4.5h4.5a.75.75 0 000-1.5h-4.5v-4.5z" />
                                    </svg>
                                    Add Category
...
<?php echo $__env->make('layouts.company', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Documents\GitHub\SMARTIMS\resources\views/company/categories/index.blade.php ENDPATH**/ ?>