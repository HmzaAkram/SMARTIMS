...
<?php $__env->startSection('title', 'System Settings - SmartIMS'); ?>
                    ...
                    <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input type="text" name="app_name" value="<?php echo e($settings['general']['app_name']); ?>"
                                       class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                            
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Application URL</label>
                                <input type="url" name="app_url" value="<?php echo e($settings['general']['app_url']); ?>"
                                       class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select name="timezone" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        <option value="America/New_York" <?php echo e($settings['general']['timezone'] == 'America/New_York' ? 'selected' : ''); ?>>America/New_York</option>
                                        <option value="Europe/London" <?php echo e($settings['general']['timezone'] == 'Europe/London' ? 'selected' : ''); ?>>Europe/London</option>
                                        <option value="Asia/Kolkata" <?php echo e($settings['general']['timezone'] == 'Asia/Kolkata' ? 'selected' : ''); ?>>Asia/Kolkata</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="currency" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                                        <option value="USD" <?php echo e($settings['general']['currency'] == 'USD' ? 'selected' : ''); ?>>USD</option>
                                        <option value="EUR" <?php echo e($settings['general']['currency'] == 'EUR' ? 'selected' : ''); ?>>EUR</option>
                                        <option value="GBP" <?php echo e($settings['general']['currency'] == 'GBP' ? 'selected' : ''); ?>>GBP</option>
                                        <option value="INR" <?php echo e($settings['general']['currency'] == 'INR' ? 'selected' : ''); ?>>INR</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="date_format" value="<?php echo e($settings['general']['date_format']); ?>"
                                           class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Time Format</label>
                                    <input type="text" name="time_format" value="<?php echo e($settings['general']['time_format']); ?>"
                                           class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                            </div>
                        ...
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="mail_host" value="<?php echo e($settings['mail']['mail_host']); ?>"
                                           class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Mail Port</label>
                                    <input type="number" name="mail_port" value="<?php echo e($settings['mail']['mail_port']); ?>"
                                           class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="mail_username" value="<?php echo e($settings['mail']['mail_username']); ?>"
                                       class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select name="mail_encryption" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                                        ...
                                        <option value="tls" <?php echo e($settings['mail']['mail_encryption'] == 'tls' ? 'selected' : ''); ?>>TLS</option>
                                        <option value="ssl" <?php echo e($settings['mail']['mail_encryption'] == 'ssl' ? 'selected' : ''); ?>>SSL</option>
                                    </select>
                                </div>
                                
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Mail From Address</label>
                                    <input type="email" name="mail_from_address" value="<?php echo e($settings['mail']['mail_from_address']); ?>"
                                           class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="mail_from_name" value="<?php echo e($settings['mail']['mail_from_name']); ?>"
                                       class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                    ...
                    <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <select name="currency" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                                    <option value="USD" <?php echo e($settings['billing']['currency'] == 'USD' ? 'selected' : ''); ?>>USD ($)</option>
                                    <option value="EUR" <?php echo e($settings['billing']['currency'] == 'EUR' ? 'selected' : ''); ?>>EUR (€)</option>
                                    <option value="GBP" <?php echo e($settings['billing']['currency'] == 'GBP' ? 'selected' : ''); ?>>GBP (£)</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="tax_rate" step="0.01" min="0" max="100" 
                                       value="<?php echo e($settings['billing']['tax_rate']); ?>"
                                       class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                            
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Invoice Prefix</label>
                                <input type="text" name="invoice_prefix" value="<?php echo e($settings['billing']['invoice_prefix']); ?>"
                                       class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="number" name="due_days" min="1" max="365"
                                           value="<?php echo e($settings['billing']['due_days']); ?>"
                                           class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="late_fee" step="0.01" min="0"
                                           value="<?php echo e($settings['billing']['late_fee']); ?>"
                                           class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                            </div>
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input type="number" name="password_min_length" min="6" max="32"
                                       value="<?php echo e($settings['security']['password_min_length']); ?>"
                                       class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center">
                                    <input type="checkbox" name="password_require_numbers" id="password_require_numbers" 
                                           <?php echo e($settings['security']['password_require_numbers'] ? 'checked' : ''); ?>
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="password_require_symbols" id="password_require_symbols"
                                           <?php echo e($settings['security']['password_require_symbols'] ? 'checked' : ''); ?>
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="password_require_mixed_case" id="password_require_mixed_case"
                                           <?php echo e($settings['security']['password_require_mixed_case'] ? 'checked' : ''); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="number" name="login_attempts" min="1" max="10"
                                           value="<?php echo e($settings['security']['login_attempts']); ?>"
                                           class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="lockout_time" min="1" max="1440"
                                           value="<?php echo e($settings['security']['lockout_time']); ?>"
                                           class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="session_timeout" min="1" max="1440"
                                       value="<?php echo e($settings['security']['session_timeout']); ?>"
                                       class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
...
<?php echo $__env->make('layouts.super-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Documents\GitHub\SMARTIMS\resources\views/super-admin/settings/index.blade.php ENDPATH**/ ?>