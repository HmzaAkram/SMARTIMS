    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg p-5 border border-gray-200 dark:border-gray-700">
            ...
            <div class="mt-2 flex items-baseline gap-2">
                <span class="text-3xl font-semibold text-gray-900 dark:text-white"><?php echo e($stats['total_items'] ?? 0); ?></span>
                <span class="text-[13px] font-medium text-green-600 dark:text-green-400 flex items-center">
                    <svg class="w-3 h-3 mr-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18"/>
                    </svg>
                    <?php echo e($stats['item_growth'] ?? 0); ?>%
                </span>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg p-5 border border-gray-200 dark:border-gray-700">
            ...
            <div class="mt-2 flex items-baseline gap-2">
                <span class="text-3xl font-semibold text-gray-900 dark:text-white"><?php echo e($stats['low_stock'] ?? 0); ?></span>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg p-5 border border-gray-200 dark:border-gray-700">
            ...
            <div class="mt-2 flex items-baseline gap-2">
                <span class="text-3xl font-semibold text-gray-900 dark:text-white">$<?php echo e(number_format($stats['value'] ?? 0)); ?></span>
                <span class="text-[13px] font-medium text-green-600 dark:text-green-400 flex items-center">
                    <svg class="w-3 h-3 mr-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18"/>
                    </svg>
                    <?php echo e($stats['value_growth'] ?? 0); ?>%
                </span>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg p-5 border border-gray-200 dark:border-gray-700">
            ...
            <div class="mt-2 flex items-baseline gap-2">
                <span class="text-3xl font-semibold text-gray-900 dark:text-white"><?php echo e($warehouses ?? 0); ?></span>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-5">
            ...
            <div class="space-y-3">
                <div class="flex items-center justify-between p-2 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                    ...
                    <span class="text-[13px] font-semibold text-gray-900 dark:text-white"><?php echo e($stockDistribution['in_stock'] ?? 0); ?>%</span>
                </div>
                <div class="flex items-center justify-between p-2 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                    <div class="flex items-center gap-3">
                    ...
                    <span class="text-[13px] font-semibold text-gray-900 dark:text-white"><?php echo e($stockDistribution['low_stock'] ?? 0); ?>%</span>
                </div>
                 <div class="flex items-center justify-between p-2 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                    <div class="flex items-center gap-3">
                    ...
                    <span class="text-[13px] font-semibold text-gray-900 dark:text-white"><?php echo e($stockDistribution['out_of_stock'] ?? 0); ?>%</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div class="px-5 py-4 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center">
                ...
                <a href="<?php echo e(route('company.stock-movements.index', ['tenant' => request()->route('tenant')])); ?>" class="text-[13px] text-gray-500 hover:text-gray-900 dark:hover:text-white font-medium">View All</a>
            </div>
                ...
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/20 transition-colors">
                            <td class="px-5 py-3">
                                <p class="text-[13px] font-medium text-gray-900 dark:text-white"><?php echo e($movement->item->name ?? 'Unknown'); ?></p>
                                <p class="text-[11px] text-gray-500"><?php echo e($movement->created_at->diffForHumans()); ?></p>
                            </td>
                            <td class="px-5 py-3">
                                <span class="inline-flex items-center px-2 py-0.5 rounded text-[11px] font-medium <?php echo e($movement->type === 'in' ? 'bg-green-50 text-green-700 dark:bg-green-500/10 dark:text-green-400' : 'bg-red-50 text-red-700 dark:bg-red-500/10 dark:text-red-400'); ?>">
                                    <?php echo e(ucfirst($movement->type)); ?>

                                </span>
                            </td>
                            <td class="px-5 py-3 text-right">
                                <span class="text-[13px] font-medium <?php echo e($movement->type === 'in' ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>">
         ...
         <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
             <div class="px-5 py-4 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center">
                <div class="flex items-center gap-2">
                 ...
                 <a href="/company/<?php echo e(request()->route('tenant')); ?>/inventory/items?filter=low_stock" class="text-[13px] text-gray-500 hover:text-gray-900 dark:hover:text-white font-medium">View All</a>
            </div>
                ...
                <div class="p-4 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-700/20 transition-colors">
                    <div class="flex items-center gap-3">
                         <div class="h-8 w-8 rounded bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-gray-400">
                            <?php if($item->image): ?>
                                <img src="<?php echo e($item->image); ?>" class="h-full w-full object-cover rounded" alt="">
                            <?php else: ?>
                        ...
                        <div>
                            <p class="text-[13px] font-medium text-gray-900 dark:text-white"><?php echo e($item->name); ?></p>
                            <p class="text-[11px] text-gray-500">SKU: <?php echo e($item->sku); ?></p>
                        </div>
                    </div>
                    <div class="text-right">
                        <p class="text-[13px] font-bold text-red-600 dark:text-red-400"><?php echo e($item->quantity); ?></p>
                        <p class="text-[11px] text-gray-400">Min: <?php echo e($item->min_quantity); ?></p>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
