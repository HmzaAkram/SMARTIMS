        ...
        >
            ...
            <div class="h-16 flex items-center justify-between px-6 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e(ucfirst(request()->route('tenant'))); ?></p>
                    </div>
                </div>
            </div>
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
                ...
                <a href="<?php echo e(route('company.dashboard', ['tenant' => request()->route('tenant')])); ?>" 
                   class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-all hover:shadow-sm <?php echo e(request()->routeIs('company.dashboard') ? 'bg-blue-50 text-blue-700 dark:bg-blue-900/20 dark:text-blue-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'); ?>" aria-label="Dashboard">
                ...
                <!-- Inventory Section -->
                <div x-data="{ open: <?php echo e(request()->routeIs('company.items.*') || request()->routeIs('company.categories.*') ? 'true' : 'false'); ?> }" class="space-y-1">
                    <button 
                        @click="open = !open"
                        class="w-full flex items-center justify-between gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-all hover:shadow-sm <?php echo e(request()->routeIs('company.items.*') || request()->routeIs('company.categories.*') ? 'bg-gray-100 text-gray-900 dark:bg-gray-700 dark:text-white' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'); ?>" aria-expanded="true" aria-controls="inventory-submenu">
                        <div class="flex items-center gap-3">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                            </svg>
                    ...
                    <div x-show="open" x-collapse id="inventory-submenu" class="ml-4 space-y-1 border-l-2 border-gray-200 dark:border-gray-700">
                        <a href="<?php echo e(route('company.items.index', ['tenant' => request()->route('tenant')])); ?>" 
                           class="flex items-center gap-3 px-4 py-2.5 text-sm rounded-lg transition-all hover:shadow-sm <?php echo e(request()->routeIs('company.items.*') ? 'text-blue-700 bg-blue-50 dark:bg-blue-900/20 dark:text-blue-400' : 'text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:hover:bg-gray-700/50'); ?>" aria-label="All Items">
                        ...
                        <a href="<?php echo e(route('company.categories.index', ['tenant' => request()->route('tenant')])); ?>" 
                           class="flex items-center gap-3 px-4 py-2.5 text-sm rounded-lg transition-all hover:shadow-sm <?php echo e(request()->routeIs('company.categories.*') ? 'text-blue-700 bg-blue-50 dark:bg-blue-900/20 dark:text-blue-400' : 'text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:hover:bg-gray-700/50'); ?>" aria-label="Categories">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/>
                            </svg>
                ...
                <a href="<?php echo e(route('company.warehouses.index', ['tenant' => request()->route('tenant')])); ?>" 
                   class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-all hover:shadow-sm <?php echo e(request()->routeIs('company.warehouses.*') ? 'bg-blue-50 text-blue-700 dark:bg-blue-900/20 dark:text-blue-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'); ?>" aria-label="Warehouses">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div x-data="{ open: <?php echo e(request()->routeIs('company.orders.*') || request()->routeIs('company.sales.*') ? 'true' : 'false'); ?> }" class="space-y-1">
                    <button 
                        @click="open = !open"
                    ...
                    <div x-show="open" x-collapse id="sales-submenu" class="ml-4 space-y-1 border-l-2 border-gray-200 dark:border-gray-700">
                        <a href="<?php echo e(route('company.orders.index', ['tenant' => request()->route('tenant')])); ?>" 
                           class="flex items-center gap-3 px-4 py-2.5 text-sm rounded-lg transition-all hover:shadow-sm <?php echo e(request()->routeIs('company.orders.*') ? 'text-blue-700 bg-blue-50 dark:bg-blue-900/20 dark:text-blue-400' : 'text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:hover:bg-gray-700/50'); ?>" aria-label="Orders">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('company.sales.index', ['tenant' => request()->route('tenant')])); ?>" 
                           class="flex items-center gap-3 px-4 py-2.5 text-sm rounded-lg transition-all hover:shadow-sm <?php echo e(request()->routeIs('company.sales.*') ? 'text-blue-700 bg-blue-50 dark:bg-blue-900/20 dark:text-blue-400' : 'text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:hover:bg-gray-700/50'); ?>" aria-label="Sales Reports">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('company.suppliers.index', ['tenant' => request()->route('tenant')])); ?>" 
                   class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-all hover:shadow-sm <?php echo e(request()->routeIs('company.suppliers.*') ? 'bg-blue-50 text-blue-700 dark:bg-blue-900/20 dark:text-blue-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'); ?>" aria-label="Suppliers">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('company.customers.index', ['tenant' => request()->route('tenant')])); ?>" 
                   class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-all hover:shadow-sm <?php echo e(request()->routeIs('company.customers.*') ? 'bg-blue-50 text-blue-700 dark:bg-blue-900/20 dark:text-blue-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'); ?>" aria-label="Customers">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Reports Section -->
                <div x-data="{ open: <?php echo e(request()->routeIs('company.reports.*') ? 'true' : 'false'); ?> }" class="space-y-1">
                    <button 
                        @click="open = !open"
                    ...
                    <div x-show="open" x-collapse id="reports-submenu" class="ml-4 space-y-1 border-l-2 border-gray-200 dark:border-gray-700">
                        ...
                        <a href="<?php echo e(route('company.reports.sales', ['tenant' => request()->route('tenant')])); ?>" 
                           class="flex items-center gap-3 px-4 py-2.5 text-sm rounded-lg transition-all hover:shadow-sm <?php echo e(request()->routeIs('company.reports.sales') ? 'text-blue-700 bg-blue-50 dark:bg-blue-900/20 dark:text-blue-400' : 'text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:hover:bg-gray-700/50'); ?>" aria-label="Sales Report">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/>
                            </svg>
                            <span>Sales Report</span>
                        </a>
                        <a href="<?php echo e(route('company.reports.stock-movements', ['tenant' => request()->route('tenant')])); ?>" 
                ...
                <a href="<?php echo e(route('company.settings', ['tenant' => request()->route('tenant')])); ?>" 
                   class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-all hover:shadow-sm <?php echo e(request()->routeIs('company.settings') ? 'bg-blue-50 text-blue-700 dark:bg-blue-900/20 dark:text-blue-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'); ?>" aria-label="Settings">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg p-4 border border-blue-100 dark:border-blue-800">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="space-y-2">
                                <a href="<?php echo e(route('company.items.create', ['tenant' => request()->route('tenant')])); ?>" class="flex items-center gap-2 text-xs text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                                    </svg>
                                    Add New Item
                                </a>
                                <a href="<?php echo e(route('company.stock-movements.create', ['tenant' => request()->route('tenant')])); ?>" class="flex items-center gap-2 text-xs text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                                    </svg>
                                    Record Movement
                    ...
                    <div class="flex items-center justify-between h-16">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <nav class="hidden md:flex items-center space-x-2 text-sm">
                                <a href="<?php echo e(route('company.dashboard', ['tenant' => request()->route('tenant')])); ?>" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                                    Dashboard
                                </a>
