        ...
        <aside x-show="sidebarOpen"
            ...
            <nav class="flex-1 overflow-y-auto sidebar-scrollbar px-4 py-6 space-y-2">
                ...
                <a href="<?php echo e(route('company.dashboard', ['tenant' => request()->route('tenant')])); ?>" 
                   class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-xl transition-all-300 <?php echo e(request()->routeIs('company.dashboard') ? 'bg-gradient-to-r from-blue-500 to-purple-500 text-white shadow-lg' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div x-data="{ open: <?php echo e(request()->routeIs('company.items.*') || request()->routeIs('company.categories.*') ? 'true' : 'false'); ?> }">
                    ...
                    <div x-show="open" x-collapse class="mt-1 ml-4 pl-4 border-l-2 border-blue-200 dark:border-blue-800 space-y-1">
                        <a href="<?php echo e(route('company.items.index', ['tenant' => request()->route('tenant')])); ?>" 
                           class="flex items-center gap-3 px-4 py-2.5 text-sm rounded-lg transition-all-300 <?php echo e(request()->routeIs('company.items.*') ? 'text-blue-700 bg-blue-50 dark:bg-blue-900/20 dark:text-blue-400' : 'text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:hover:bg-gray-700/50'); ?>">
                        ...
                        <a href="<?php echo e(route('company.categories.index', ['tenant' => request()->route('tenant')])); ?>" 
                           class="flex items-center gap-3 px-4 py-2.5 text-sm rounded-lg transition-all-300 <?php echo e(request()->routeIs('company.categories.*') ? 'text-blue-700 bg-blue-50 dark:bg-blue-900/20 dark:text-blue-400' : 'text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:hover:bg-gray-700/50'); ?>">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('company.warehouses.index', ['tenant' => request()->route('tenant')])); ?>" 
                   class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-xl transition-all-300 <?php echo e(request()->routeIs('company.warehouses.*') ? 'bg-gradient-to-r from-blue-500 to-purple-500 text-white shadow-lg' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('company.stock-movements.index', ['tenant' => request()->route('tenant')])); ?>" 
                   class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-xl transition-all-300 <?php echo e(request()->routeIs('company.stock-movements.*') ? 'bg-gradient-to-r from-blue-500 to-purple-500 text-white shadow-lg' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div x-data="{ open: <?php echo e(request()->routeIs('company.orders.*') || request()->routeIs('company.sales.*') ? 'true' : 'false'); ?> }">
                    ...
                    <div x-show="open" x-collapse class="mt-1 ml-4 pl-4 border-l-2 border-blue-200 dark:border-blue-800 space-y-1">
                        <a href="<?php echo e(route('company.orders.index', ['tenant' => request()->route('tenant')])); ?>" 
                           class="flex items-center gap-3 px-4 py-2.5 text-sm rounded-lg transition-all-300 <?php echo e(request()->routeIs('company.orders.*') ? 'text-blue-700 bg-blue-50 dark:bg-blue-900/20 dark:text-blue-400' : 'text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:hover:bg-gray-700/50'); ?>">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="<?php echo e(route('company.sales.index', ['tenant' => request()->route('tenant')])); ?>" 
                           class="flex items-center gap-3 px-4 py-2.5 text-sm rounded-lg transition-all-300 <?php echo e(request()->routeIs('company.sales.*') ? 'text-blue-700 bg-blue-50 dark:bg-blue-900/20 dark:text-blue-400' : 'text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:hover:bg-gray-700/50'); ?>">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('company.suppliers.index', ['tenant' => request()->route('tenant')])); ?>" 
                   class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-xl transition-all-300 <?php echo e(request()->routeIs('company.suppliers.*') ? 'bg-gradient-to-r from-blue-500 to-purple-500 text-white shadow-lg' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('company.customers.index', ['tenant' => request()->route('tenant')])); ?>" 
                   class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-xl transition-all-300 <?php echo e(request()->routeIs('company.customers.*') ? 'bg-gradient-to-r from-blue-500 to-purple-500 text-white shadow-lg' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div x-data="{ open: <?php echo e(request()->routeIs('company.reports.*') ? 'true' : 'false'); ?> }">
                    ...
                    <div x-show="open" x-collapse class="mt-1 ml-4 pl-4 border-l-2 border-blue-200 dark:border-blue-800 space-y-1">
                        <a href="<?php echo e(route('company.reports.inventory', ['tenant' => request()->route('tenant')])); ?>" 
                           class="flex items-center gap-3 px-4 py-2.5 text-sm rounded-lg transition-all-300 <?php echo e(request()->routeIs('company.reports.inventory') ? 'text-blue-700 bg-blue-50 dark:bg-blue-900/20 dark:text-blue-400' : 'text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:hover:bg-gray-700/50'); ?>">
                            <span>Inventory Report</span>
                        </a>
                        <a href="<?php echo e(route('company.reports.sales', ['tenant' => request()->route('tenant')])); ?>" 
                           class="flex items-center gap-3 px-4 py-2.5 text-sm rounded-lg transition-all-300 <?php echo e(request()->routeIs('company.reports.sales') ? 'text-blue-700 bg-blue-50 dark:bg-blue-900/20 dark:text-blue-400' : 'text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:hover:bg-gray-700/50'); ?>">
                ...
                <a href="<?php echo e(route('company.settings', ['tenant' => request()->route('tenant')])); ?>" 
                   class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-xl transition-all-300 <?php echo e(request()->routeIs('company.settings') ? 'bg-gradient-to-r from-blue-500 to-purple-500 text-white shadow-lg' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
