        ...
        <aside x-show="sidebarOpen"
            ...
            <nav class="flex-1 overflow-y-auto sidebar-scrollbar px-4 py-6 space-y-2">
                ...
                <a href="<?php echo e(route('company.dashboard', ['tenant' => request()->route('tenant')])); ?>" 
                   class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-xl transition-all-300 <?php echo e(request()->routeIs('company.dashboard') ? 'bg-gradient-to-r from-blue-500 to-purple-500 text-black shadow-lg' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('company.warehouses.index', ['tenant' => request()->route('tenant')])); ?>" 
                   class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-xl transition-all-300 <?php echo e(request()->routeIs('company.warehouses.*') ? 'bg-gradient-to-r from-blue-500 to-purple-500 text-black shadow-lg' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('company.stock-movements.index', ['tenant' => request()->route('tenant')])); ?>" 
                   class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-xl transition-all-300 <?php echo e(request()->routeIs('company.stock-movements.*') ? 'bg-gradient-to-r from-blue-500 to-purple-500 text-black shadow-lg' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('company.suppliers.index', ['tenant' => request()->route('tenant')])); ?>" 
                   class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-xl transition-all-300 <?php echo e(request()->routeIs('company.suppliers.*') ? 'bg-gradient-to-r from-blue-500 to-purple-500 text-black shadow-lg' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('company.customers.index', ['tenant' => request()->route('tenant')])); ?>" 
                   class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-xl transition-all-300 <?php echo e(request()->routeIs('company.customers.*') ? 'bg-gradient-to-r from-blue-500 to-purple-500 text-black shadow-lg' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('company.settings', ['tenant' => request()->route('tenant')])); ?>" 
                   class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-xl transition-all-300 <?php echo e(request()->routeIs('company.settings') ? 'bg-gradient-to-r from-blue-500 to-purple-500 text-black shadow-lg' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
