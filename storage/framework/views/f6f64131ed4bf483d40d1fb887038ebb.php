    ...
    <div class="min-h-screen bg-gradient-to-br from-indigo-100 via-white to-purple-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-2xl">
            ...
            <p class="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
                ...
                <a href="<?php echo e(route('login')); ?>" class="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">
                    Sign in
                </a>
            </p>
        </div>
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-2xl">
            <div class="bg-white dark:bg-gray-800 py-8 px-4 shadow-xl sm:rounded-lg sm:px-10">
                ...
                <form class="space-y-6" method="POST" action="<?php echo e(route('register-company.post')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <input id="company_name" name="company_name" type="text" required value="<?php echo e(old('company_name')); ?>" class="block w-full rounded-md border-0 py-2 px-3 text-gray-900 dark:text-white dark:bg-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <input id="company_email" name="company_email" type="email" required value="<?php echo e(old('company_email')); ?>" class="block w-full rounded-md border-0 py-2 px-3 text-gray-900 dark:text-white dark:bg-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <input id="company_phone" name="company_phone" type="tel" required value="<?php echo e(old('company_phone')); ?>" class="block w-full rounded-md border-0 py-2 px-3 text-gray-900 dark:text-white dark:bg-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    <div class="flex rounded-md shadow-sm">
                                        <input type="text" name="subdomain" id="subdomain" required value="<?php echo e(old('subdomain')); ?>" class="block w-full min-w-0 flex-1 rounded-l-md border-0 py-2 px-3 text-gray-900 dark:text-white dark:bg-gray-700 ring-1 ring-inset ring-gray-300 dark:ring-gray-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <input id="name" name="name" type="text" required value="<?php echo e(old('name')); ?>" class="block w-full rounded-md border-0 py-2 px-3 text-gray-900 dark:text-white dark:bg-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <input id="email" name="email" type="email" autocomplete="email" required value="<?php echo e(old('email')); ?>" class="block w-full rounded-md border-0 py-2 px-3 text-gray-900 dark:text-white dark:bg-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                                </div>
                            </div>
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                            <?php $__currentLoopData = ['free' => 'Free', 'standard' => 'Standard', 'premium' => 'Premium']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div>
                                <input type="radio" name="plan" id="plan_<?php echo e($value); ?>" value="<?php echo e($value); ?>" <?php echo e(old('plan', 'free') == $value ? 'checked' : ''); ?> class="peer hidden">
                                <label for="plan_<?php echo e($value); ?>" class="block cursor-pointer rounded-lg border-2 border-gray-300 dark:border-gray-600 p-4 hover:border-indigo-500 peer-checked:border-indigo-600 peer-checked:ring-2 peer-checked:ring-indigo-600">
                                    <div class="text-center">
                                        <p class="text-lg font-semibold text-gray-900 dark:text-white"><?php echo e($label); ?></p>
                                        <p class="text-2xl font-bold text-indigo-600 dark:text-indigo-400 mt-2">
                                            <?php if($value === 'free'): ?>
                                                Free
                                            <?php elseif($value === 'standard'): ?>
                                                $29/mo
                                            <?php else: ?>
                                                $79/mo
                                            <?php endif; ?>
...
</html><?php /**PATH C:\Users\HP\Documents\GitHub\SMARTIMS\resources\views/auth/register.blade.php ENDPATH**/ ?>