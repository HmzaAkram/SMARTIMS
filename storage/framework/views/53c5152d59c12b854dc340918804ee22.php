...
<?php $__env->startSection('title', 'Inventory Items - SmartIMS'); ?>
...
<div class="space-y-6">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <div class="mt-4 sm:mt-0">
          <a href="<?php echo e(route('company.items.create', ['tenant' => request()->route('tenant')])); ?>" class="inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500">
    ...
    <div class="rounded-lg bg-white shadow p-4">
        ...
        <div class="mt-4 flex items-center justify-between">
            ...
            <div class="text-sm text-gray-500">
                Showing <?php echo e($items->firstItem() ?? 1); ?> to <?php echo e($items->lastItem() ?? 10); ?> of <?php echo e($items->total() ?? 245); ?> results
            </div>
        </div>
    </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="whitespace-nowrap px-3 py-4">
                            <div class="flex items-center">
                                <div class="h-12 w-12 flex-shrink-0">
                                    <img class="h-12 w-12 rounded-lg object-cover" src="<?php echo e(asset('storage/' . $item->image)); ?>" alt="<?php echo e($item->name); ?>" alt="">
                                </div>
                                <div class="ml-4">
                        ...
                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-900 font-mono"><?php echo e($item->sku); ?></td>
                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?php echo e($item->category->name); ?></td>
                        <td class="whitespace-nowrap px-3 py-4 text-sm">
                            <span class="font-semibold text-gray-900"><?php echo e($item->quantity); ?></span>
                            <span class="text-gray-500"> <?php echo e($item->unit); ?></span>
                        </td>
                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-900">$<?php echo e(number_format($item->unit_price, 2)); ?></td>
                        <td class="whitespace-nowrap px-3 py-4 text-sm">
                        ...
                        <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                            <div class="flex justify-end space-x-2" x-data="{ open: false }">
                                <a href="<?php echo e(route('company.items.show', [$tenant, $item])); ?>" class="text-indigo-600 hover:text-indigo-900">View</a>
                                <a href="<?php echo e(route('company.items.edit', [$tenant, $item])); ?>" class="text-gray-600 hover:text-gray-900">Edit</a>
                                    ...
                                    <div class="flex min-h-screen items-end justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                                        ...
                                        <div x-show="open" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" x-transition:enter-end="opacity-100 translate-y-0 sm:scale-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100 translate-y-0 sm:scale-100" x-transition:leave-end="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" class="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                                            ...
                                            <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                                <form method="POST" action="<?php echo e(route('company.items.destroy', [$tenant, $item])); ?>" class="inline">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.company', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Documents\GitHub\SMARTIMS\resources\views/inventory/items/index.blade.php ENDPATH**/ ?>