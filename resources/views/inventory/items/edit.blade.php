...
@section('title', 'Edit Item - SmartIMS')
...
<div class="space-y-6">
        ...
        <ol class="flex items-center space-x-4">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ml-4 text-sm font-medium text-gray-900">Edit Item</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div>
        ...
        <p class="mt-1 text-sm text-gray-500">Update item information and stock details</p>
    </div>

    {{-- Form --}}
    <form method="POST"
          action="{{ route('company.items.update', [$tenant, $item]) }}"
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="name" id="name"
                               ...
                               required
                               class="mt-2 block w-full rounded-md border-0 py-2 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                        @error('name')
                    ...
                    <div>
                        ...
                        <input type="text" name="sku" id="sku"
                               ...
                               required
                               class="mt-2 block w-full rounded-md border-0 py-2 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm font-mono">
                        @error('sku')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex rounded-md shadow-sm">
                            <input type="text" name="barcode" id="barcode"
                                   ...
                                   class="block w-full rounded-l-md border-0 py-2 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm font-mono">
                    ...
                    <div>
                        ...
                        <select name="category_id" id="category_id" required
                                class="mt-2 block w-full rounded-md border-0 py-2 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="3"
                                  class="mt-2 block w-full rounded-md border-0 py-2 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">{{ old('description', $item->description) }}</textarea>
                        @error('description')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative mt-2 rounded-md shadow-sm">
                            ...
                            <input type="number" name="unit_price" id="unit_price"
                                   ...
                                   step="0.01" required
                                   class="block w-full rounded-md border-0 py-2 pl-7 pr-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
                        </div>
                        @error('unit_price')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
