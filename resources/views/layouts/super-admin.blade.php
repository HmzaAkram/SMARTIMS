...
<head>
    ...
    <title>@yield('title', 'SmartIMS - Super Admin')</title>
                ...
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-gray-600 mt-1">@yield('subtitle', 'Manage your multi-tenant platform')</p>
                        </div>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="hidden md:flex items-center space-x-6">
                                <div class="text-center">
                                    <p class="text-2xl font-bold text-indigo-600">{{ $totalCompanies ?? 0 }}</p>
